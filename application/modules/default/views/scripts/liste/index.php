        ...
        <form method="post" action="">
            ...
            <table id="sample-table-2" class="table table-striped table-bordered table-hover" width="95%">
                ...
                <tbody>
                    ...
                    <?php } ?>
                        <tr>
                            <td colspan="3" align="right">Prix total de la liste : </td>
                            <td><?php echo $this->FormatXfp($prix_total); ?></td>                       
                        </tr>
                        <tr>
                            <td colspan="3" align="right">Prix total déjà payé:</td>
                            <td><?php echo $this->FormatXfp($prix_paye); ?></td>                       
                        </tr>
                        <tr>
                            <td colspan="3" align="right">Prix total restant à payé:</td>
