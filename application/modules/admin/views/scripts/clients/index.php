<div class="page-header">
    <h1>Administration <small><i class="icon-double-angle-right"></i>Liste des clients :</small></h1>
</div>
<div class="row">
    <div class="col-xs-12">      
        <p><strong>Liste : </strong> Nombre de liste dont le client a effectué un paiement depuis son inscription.</p>
        <p><strong>Liste 30 jours : </strong> Nombre de liste dont le client a effectué un paiement au cours des 30 derniers jours.</p>
        ...
        <?php if (count($this->paginator)) { ?>
            <table id="sample-table-2" class="table table-striped table-bordered table-hover" width="95%">
                ...
                echo ($liste->adresse_3) ? '<br />' . $liste->adresse_3 : ''; ?> </td>
